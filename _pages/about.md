...
- AI agents for web, mobile, and GUI environments
- Planning, reasoning, and grounded action with LLMs and VLMs
- Scalable data generation and evaluation for agents
- Language grounding, task structure, and representation learning
